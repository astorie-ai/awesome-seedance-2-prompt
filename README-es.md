Last updated on 2026-06-30 12-38-03
...
> Una coleccion curada de los **mejores prompts de Seedance 2.0**, tecnicas de generacion de video y recursos para experimentos avanzados con **Martini Art**.

Este repositorio se centra en **prompts de Seedance 2.0 de alta fidelidad** obtenidos de Martini Art y prompt engineers destacados. Tanto si buscas **transiciones cinematograficas**, **consistencia de personajes** o **secuencias de movimiento complejas**, aqui encontraras las entradas mas efectivas para liberar todo el potencial de **Martini Art**.
